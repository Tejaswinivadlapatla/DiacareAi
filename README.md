...
- 🍽️ **Meal Planner**
- ⚖️ **BMI Calculator**
<img width="1622" height="476" alt="image" src="https://github.com/user-attachments/assets/8a094db5-5433-4338-8364-3e376fbeca46" />
...
```bash
git clone https://github.com/Tejaswinivadlapatla/DiacareAi.git
```
...
This application is intended for educational purposes and preliminary health awareness only. It is **not** a substitute for professional medical advice, diagnosis, or treatment.
